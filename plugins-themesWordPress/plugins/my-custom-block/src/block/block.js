...
registerBlockType( 'cgb/block-my-custom-block', {
	 ...
	 */
	edit: ( props ) => {
		// Creates a <p class='wp-block-cgb-block-my-custom-block'></p>.
		return (
